 ...
 */
@ApiModel(value="案件",description="案件")
public class CasesVO {
	 ...
	 * 受理接收单位
	 */
	@ApiModelProperty(value="受理接收单位")
	private String sljsdw;
	/**
	 * 受理接收单位名称
	 */
	@ApiModelProperty(value="受理接收单位名称")
	private String sljsdwCn;
	/**
	 * 警综案件状态
	 */
	@ApiModelProperty(value="警综案件状态")
	 ...
	 * 本地案件状态名称
	 */
	@ApiModelProperty(value="本地案件状态名称")
	 ...
	 * 案件结束时间
	 */
	@ApiModelProperty(value="案件结束时间")
	private String fasjzz;
	/**
	 * 作案状态
	 */
	@ApiModelProperty(value="作案状态")
	private String zazt;
	/**
	 * 作案状态名称
	 */
	@ApiModelProperty(value="作案状态名称")
	private String zaztCn;
	/**
	 * 报警受理号
	 */
	@ApiModelProperty(value="报警受理号")
	private String slBjslh;
	/**
	 * 接警方式
	 */
	@ApiModelProperty(value="接警方式")
	private String slJjfs;
	/**
	 * 接警方式
	 */
	@ApiModelProperty(value="接警方式中文表示")
	 ...
	 * 案件危害
	 */
	@ApiModelProperty(value="案件危害")
	private String ajwh;
	/**
	 * 受理接警时间
	 */
	@ApiModelProperty(value="受理接警时间")
	 ...
	 * 案件危害程度
	 */
	@ApiModelProperty(value="案件危害程度")
	private String ajwhcdCn;
	/**
	 * 补立原因
	 */
	@ApiModelProperty(value="补立原因")
	private String blyy;
	/**
	 * 主要案情
	 */
	@ApiModelProperty(value="主要案情")
	private String zyaq;
	/**
	 * 选择时机
	 */
	 ...
	 * 涉案主体
	 */
	@ApiModelProperty(value="涉案主体")
	private String sazz;
	/**
	 * 涉案主体名称
	 */
	@ApiModelProperty(value="涉案主体名称")
	 ...
	 * 立案人员
	 */
	@ApiModelProperty(value="立案人员")
	private String ajlary;
	/**
	 * 立案人员名称
	 */
	@ApiModelProperty(value="立案人员名称")
	 ...
	 * 案件主办人员（警号）
	 */
	@ApiModelProperty(value="案件主办人员（警号）")
	private String ajzbry;
	/**
	 * 案件主办人员名称
	 */
	@ApiModelProperty(value="案件主办人员名称")
	private String ajzbryCn;
	/**
	 * 案件协办人员（多个警号逗号分隔）
	 */
	@ApiModelProperty(value="案件协办人员（多个警号逗号分隔）")
	private String ajxbry;
	/**
	 * 案件协办人员名称
	 */
	@ApiModelProperty(value="案件协办人员名称")
	 ...
	 */
	@ApiModelProperty(value="案件来源类型（1、从警综提取，2、手动录入案件）")
	...
	/**
	 * 案件主办状态（列表查询条件）：全部、我主办、我协办、我提取、我合成作战
	 */
	private Integer caseSponsor;
	...
	/**
	 * 添加案件协办人员按钮，true可添加，false不可添加
	 */
	@ApiModelProperty(value="添加案件协办人员按钮，true可添加，false不可添加")
	private Boolean addAjxbry;
	...
	public Integer getCaseSponsor() {
		return caseSponsor;
	}

	public void setCaseSponsor(Integer caseSponsor) {
	...
	public Boolean getAddAjxbry() {
		return addAjxbry;
	}

	public void setAddAjxbry(Boolean addAjxbry) {
		this.addAjxbry = addAjxbry;
	}
	...
	public String getLrryCn() {
		return lrryCn;
	}

	public void setLrryCn(String lrryCn) {
		this.lrryCn = lrryCn;
	}
