package com.hyzs.cidyth.communicate.http;
...
public class HttpUtil {
	 ...
	 * @throws IOException
	 */
	public String postByte(String url, byte[] content, String mimeType, Charset charset, Map<String, String> httpHeader,
	 ...
	 * @throws IOException
	 */
	public String postByte(String url,byte[] content) throws IOException {
	 ...
	 * @throws IOException
	 */
	public String postByte(String url) throws IOException {
